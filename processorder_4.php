...
$products=array("$date", "$tireqty", "$oilqty", "$sparkqty", "$gar", "$total", "$address", "$fio");
...
//echo "$products[7] <br>";
  ...
  $outputstring = $products[0]."\t".$products[1]." автопокрышек \t".$products[2]." масла\t"
                  ...
                  .$products[3]." свечей\t".$products[4]." щеток\t\$".$products[5]

                  ."\t Адрес доставки товара\t ". $products[6]."\t ФИО клиента:\t".$products[7]." \n";
